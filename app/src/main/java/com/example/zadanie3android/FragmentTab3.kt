...
import com.example.zadanie3android.databinding.FragmentTab3Binding
 ...
 * Use the [FragmentTab3.newInstance] factory method to
...
class FragmentTab3 : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.choose.setOnClickListener {
            ...
            sharedViewModel.setSelectedImage(R.drawable.flower)
        }
        return binding.root
    }
